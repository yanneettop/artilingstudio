...
const materialRecords: readonly Material[] = [
  ...
  material({
    ...
    colours: ["Grey", "Charcoal", "Warm Grey"], applications: ["Bathrooms", "Feature Walls", "Vanity Units", "Large-Format Installations"], finishes: ["Matt", "Honed"], image: "/images/materials/ceppo-di-gre.webp", imageAlt: "Ceppo di Gré aggregate stone-effect porcelain surface with grey mineral pattern", relatedMaterials: ["pietra-grey", "terrazzo"], filterGroups: ["stone-effect", "decorative"], sinkSuitability: "possible", sinkSuitabilityLabel: "Suitable for selected sinks", recommendedUseShort: "Architectural walls & vanities",
  }),
  material({
